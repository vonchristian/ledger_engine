...
class Voucher < ApplicationRecord
  ...
  has_many :debit_amounts, class_name: 'Vouchers::VoucherDebitAmount', dependent: :destroy
  has_many :credit_amounts, class_name: 'Vouchers::VoucherCreditAmount', dependent: :destroy
