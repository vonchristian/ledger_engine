...
describe 'POST /api/v1/business_savings/:id/cash_deposit_confirmations', type: :request do
  context 'with valid params' do
    ...
    it 'create a business saving cash deposit confirmation' do
      ...
      url     = "/api/v1/business_savings/#{business_saving.id}/cash_deposit_confirmations"
      params  = { business_savings_cash_deposit_confirmation: { deposit_voucher_id: deposit_voucher.id } }
